...
bool Player::onKilledCreature(Creature* target, DeathEntry& entry)
{
	...
	//player has a flag to not drop loot, like AOL
...
//in case player get a critical hit
void Player::sendCritical() const
{
	if(g_config.getBool(ConfigManager::DISPLAY_CRITICAL_HIT))
	{
		//g_game.addAnimatedText(getPosition(), COLOR_ORANGE, "CRITICAL!");
		g_game.addMagicEffect(getPosition(), MAGIC_EFFECT_YALAHARIGHOST);
	}
}
